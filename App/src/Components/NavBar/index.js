                ...
                <ul className="navbar-nav">
                    ...
                    <li className="nav-item dropdown">
                        ...
                        <div className="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            ...
                            <Link className="dropdown-item" to="/Categories/men-clothing">Men clothing</Link>
                            <Link className="dropdown-item" to="/Categories/women-clothing">Women clothing</Link>
                        </div>
